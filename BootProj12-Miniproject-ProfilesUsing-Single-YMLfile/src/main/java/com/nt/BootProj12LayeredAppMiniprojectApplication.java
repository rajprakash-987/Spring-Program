...
public class BootProj12LayeredAppMiniprojectApplication {

	public static void main(String[] args) {
		
		ApplicationContext ctx=SpringApplication.run(BootProj12LayeredAppMiniprojectApplication.class, args);
