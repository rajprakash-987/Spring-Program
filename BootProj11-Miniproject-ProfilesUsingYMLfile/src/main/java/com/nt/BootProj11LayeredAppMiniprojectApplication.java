...
public class BootProj11LayeredAppMiniprojectApplication {

	public static void main(String[] args) {
		
		ApplicationContext ctx=SpringApplication.run(BootProj11LayeredAppMiniprojectApplication.class, args);
